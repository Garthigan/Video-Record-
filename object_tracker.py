...
rtsp_link = parsed_data['rtsp_link']
...
def main(_argv):
    ...
    start_time_10_min = time.time()
    ten_minutes = 600  #added by Garthi to save video for 10 mins
    ...
    while True:
       ...
       # if start_time_10_min - time.time() > ten_minutes:
